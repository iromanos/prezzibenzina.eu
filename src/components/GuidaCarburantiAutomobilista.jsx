...
const GuidaCarburantiAutomobilista = ({riepilogo, distributori, titoloPagina}) => {
    ...
    const generaDatiEGuida = (datiRiepilogo, listaDistributori, titoloPagina) => {
    ...
    const dati = generaDatiEGuida(riepilogo, distributori, titoloPagina);
            ...
            <main className="">
                ...
                <section className="mb-4">
                    ...
                    <p className="mb-3">
                        ...
                        un fattore cruciale per il bilancio familiare o aziendale.</p>
                    <p>Muoversi tra le strade di questa
                ...
                <section className="mb-4">
                    ...
                    <p className="mb-3">
                        ...
                        oscillare all'interno dello stesso perimetro comunale.</p>
                    <p>Se consideriamo che il prezzo medio
                    ...
                    <p className="">
                        ...
                        toccare la quota considerevole di <strong>{dati.maxPrezzo} euro al litro</strong>.</p>
                ...
                <section className="mb-4">
                    ...
                    <p className="mb-3">
                        ...
                        territorio.</p>
                    <p>La mappa dei loghi petroliferi in questa zona vede la coesistenza di diversi
                    ...
                    {dati.haPompeBianche ? (
                        ...
                        <><p className="">
                            ...
                            stesse compagnie principali a sfidarsi a colpi di centesimi.</p>

                            <p>Questa dinamica spinge i
